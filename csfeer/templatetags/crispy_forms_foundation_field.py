...
have correct USWDS error class on input element.
"""
...
class CrispyUSWDSFieldNode(CrispyFieldNode):
    """
    Override original Node object to manage field in a proper way for USWDS
    classes.
    """
    ...
    def render(self, context):
        ...
        converters = {
            "textinput": "usa-input",
            "fileinput": "usa-file-input",
            "passwordinput": "usa-input",
            "inputelement": "usa-input",
            "errorcondition": "usa-input--error",
        }
...
def crispy_field(parser, token):
    """
    Override original template filter to use the ``CrispyUSWDSFieldNode``.
    ...
    return CrispyUSWDSFieldNode(field, attrs)
